<div class="footer">
<div class="footer__logo">DRIVEBET</div>
<nav class="foot_nav">
                <a class="foot_nav__link" name="about" href="#">ООО "Drivebet"</a>
                <a class="foot_nav__link" name="service" href="#">Ул.Пушкина д-41</a>
                <a class="foot_nav__link" name="blog" href="#">8(800)555-35-35</a>
            </nav>
            <br><nav class="foot_nav">
